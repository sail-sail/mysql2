...
import Query from "./protocol/sequences/Query.d.ts";
import {OkPacket, RowDataPacket, FieldPacket, ResultSetHeader} from './protocol/packets/index.d.ts';
...
declare class Pool extends EventEmitter {
    ...
    getConnection(callback: (err: ErrnoException, connection: PoolConnection) => any): void;
    ...
    end(callback?: (err: ErrnoException | null, ...args: any[]) => any): void;
