...
import Sequence from "./Sequence.d.ts";
import {OkPacket, RowDataPacket, FieldPacket} from '../packets/index.d.ts';
import { ErrnoException, Readable } from "../../../../../deps.ts";
...
declare namespace Query {
    ...
    export interface QueryError extends ErrnoException {
        /**
