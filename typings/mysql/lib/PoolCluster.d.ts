...
import PoolConnection from "./PoolConnection.d.ts";
import {PoolOptions} from './Pool.d.ts';
import {EventEmitter, ErrnoException} from '../../../deps.ts';
...
declare class PoolCluster extends EventEmitter {
    ...
    getConnection(callback: (err: ErrnoException | null, connection: PoolConnection) => void): void;
    getConnection(group: string, callback: (err: ErrnoException | null, connection: PoolConnection) => void): void;
    getConnection(group: string, selector: string, callback: (err: ErrnoException | null, connection: PoolConnection) => void): void;
