...
import type { ErrnoException, Buffer } from "./deps.ts";
import {
...
import * as mysql from './typings/mysql/index.d.ts';
export * from './typings/mysql/index.d.ts';
export * from "./deps.ts";
...
export interface Pool extends mysql.Connection {
  ...
  getConnection(
    callback: (err: ErrnoException, connection: PoolConnection) => any
  ): void;
